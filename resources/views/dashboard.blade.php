<x-app-layout>
            ...
            <div
                ...
                <div class="z-10 shrink-0">
                    <button @click="showModal = true"
                        class="bg-[#1A1A1A] text-[#FAF9F6] px-6 py-3 rounded-full text-sm font-semibold hover:bg-gray-800 transition-all shadow-md hover:-translate-y-0.5">
                    ...
                    <form method="POST" action="{{ route('create.colocation') }}" class="space-y-5">
                        ...
                        <div class="mt-8 flex items-center justify-end gap-3">
                            <button type="button" @click="showModal = false"
                                class="px-5 py-2.5 text-sm font-semibold text-gray-600 hover:bg-gray-50 rounded-full transition-colors">
                                Annuler
                            </button>
                            <button type="submit"
    ...
    @if ($errors->has('colocation'))
        <div class="mb-4 p-3 bg-red-50 text-red-600 text-sm rounded-2xl border border-red-100">
