        ...
        <div class="flex justify-between h-20"> 
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-6">
                ...
                <div class="flex items-center gap-6">
                    <div class="flex items-center gap-2.5 px-4 py-1.5 bg-orange-50 border border-orange-100 rounded-2xl shadow-sm hover:bg-orange-100/50 transition-all cursor-default group">
                        <div class="flex items-center justify-center w-6 h-6 bg-orange-400 rounded-lg text-white shadow-sm group-hover:rotate-12 transition-transform">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
                        </div>
                        <div class="flex flex-col leading-none">
                            <span class="text-[9px] font-black uppercase tracking-[0.1em] text-orange-500/80 mb-0.5">Reputation</span>
                            <span class="text-sm font-extrabold text-[#1A1A1A]">{{ Auth::user()->reputation ?? 0 }}</span>
                        </div>
                    </div>
